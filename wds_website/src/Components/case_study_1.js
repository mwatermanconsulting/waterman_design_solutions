                ...
                <div className="container-grid-cs margin-top-150">
                    ...
                    <div className="item-c content-header flex-layout-column flex-items-justified-center" >
                        <div className="title-case margin-bottom-20"  style ={{width:'60%'}}>Methodology Begins</div>
                            <div className="subtitle-case margin-bottom-20"  style ={{width:'60%'}}>Finding the Truth</div>
                                <div className="content-block-60">
                    ...
                    <div className="item-e content-header flex-layout-column flex-items-justified-center">
                        <div className="title-case margin-bottom-20"  style ={{width:'60%'}}>The Truth</div>
                            <div className="subtitle-case margin-bottom-20"  style ={{width:'60%'}}>Presenting the Truth</div>
                                <div className="content-block-60">
                    ...
                    <div className="item-e content-header flex-layout-column flex-items-justified-center">
                        <div className="title-case margin-bottom-20"  style ={{width:'60%'}}>Solutions</div>
                            <div className="subtitle-case margin-bottom-20"  style ={{width:'60%'}}>Design Solutions</div>
                                <div className="content-block-60">
                                        <p className="content-text-18">Every consultation engagement presents its challenges. Understanding the user and the business is essential. 
                                        WDS started by doing a creative design critique on the current modem UI. The main goal of competitors research is to find out if and how they solved the same problems and issues. What were their design solutions. </p>
                    ...
                    <div className="item-e content-header flex-layout-column flex-items-justified-center">
                        <div className="title-case margin-bottom-20"  style ={{width:'60%'}}>Challenges</div>
                            <div className="subtitle-case margin-bottom-20"  style ={{width:'60%'}}>Unforseen Challenges</div>
                                <div className="content-block-60" >
                                        <p className="content-text-18">Every consultation engagement presents its challenges. Understanding the user and the business is essential. 
                                        WDS started by doing a creative design critique on the current modem UI. The main goal of competitors research is to find out if and how they solved the same problems and issues. What were their design solutions. </p>
                    ...
                    <div className="item-e content-header flex-layout-column flex-items-justified-center">
                        <div className="title-case margin-bottom-20" style ={{width:'60%'}}>Solutions</div>
                            <div className="subtitle-case margin-bottom-20" style ={{width:'60%'}}>In-Context Help </div>
                                <div className="content-block-60">
                                        <p className="content-text-18">Every consultation engagement presents its challenges. Understanding the user and the business is essential. 
                                        WDS started by doing a creative design critique on the current modem UI. The main goal of competitors research is to find out if and how they solved the same problems and issues. What were their design solutions. </p>
