...
class design_solutions extends Component {
    render () {
        ...
        <div className="flex-layout-column"> 
            ...
            <div className="flex-layout-section-full align-items-center content-block-60">
            ...
            <div className="flex-layout-section-full align-items-center content-block-60">
                 <NavLink className='button-area no-decoration content-block-60' value="learn more" type="button" to={'/website_design'}>
                    Learn More
                </NavLink>  
             </div> 
