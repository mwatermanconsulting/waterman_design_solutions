            ...
            <div className="thin-hr width-70 align-self-center margin-top-75 margin-bottom-75"></div>
                ...
                <section className="float-left flex-layout-section-full align-items-center flex-layout-column">
                        ...
                        <img className="photo-container" src={strategy5}  alt="Stakeholder Interview" /> 
                            ...
                            The Persona definition is that one or several fictional characters that can represent the majority of the potential users of product with conventional user demands and they are created through a great amount of quantitative and qualitative research. Persona answers the question “Who do we design for?” It is a powerful tool based on research findings in helping product function creation by optimizing the UX research and it not only represents a specific user but all of them, it can be understood as a typical character of the behavior, attitude, skills and contexts of all potential users.</p>
                        </div>
                    </section>
