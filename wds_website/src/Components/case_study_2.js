...
class case_study_2 extends Component {
    render () {
        return(
            <div>
            <Helmet>
                <meta name="description" content="  StubHub planned to develop an internal business intelligence platform. Their two initial releases were not successful and after a year gained little user traction. They turned to WDS for answers and six months later this failure turned into a success.  " />
            ...
            <div className="flex-layout-column flex-layout-section-full image-background-border-top">
                ...
                <section className="flex-layout-section-fixed-sm margin-top-50">
                    <div className="content-header flex-layout-center-center"> 
                        <div className="content-block-65 subtitle margin-top-25sm"> 
                        StubHub planned to develop an internal business intelligence platform. Their two initial releases were not successful and after a year gained little user traction. They turned to WDS for answers and six months later this failure turned into a success. 
                        </div>
                    </div>
                </section>  
                ...
                <section className="flex-layout-section-full align-items-center margin-top-15sm" >
                    ...
                    <div className="subtitle content-block-65 margin-top-10">
                        ...
                        <div className="content-block-65 margin-top-15">
                            <p className="content-text-18">
                            The first part of the WDS methodology was to research and fully understand the business objectives by gathering business requirements, marketing materials and style guides. Then communication was established with strategies, coordinating stakeholder interviews and holding meetings. During the initial meeting with the stakeholders, WDS asked "how many users are currently on the platform?", the answer was "only one."
                            </p>
                ...
                <section className="flex-layout-section-full margin-top-15">
                     <div className="container-image-block flex-layout-center-center flex-layout-column">
                ...
                <section className="flex-layout-section-full align-items-center">       
                    ...
                    <div className="content-block-65 margin-top-15">
                        <p className="content-text-18"> 
                        The easiest way to uncover the truth is observing users in action. There were two questions: "Why only one user?" and "What was the underlying issue that caused the analysts to ignore the platform?" WDS was trying to understand how they could observe the users if no one was using the platform. To understand this problem further attention was focused on the current UI and a design critique was done, forming a hypothesis on the problems. This hypothesis helped formed a series of interview questions for the analysts. The unique part of StubHub project was interviewing users directly, helping them understand their workflows and issues they were having with the business intelligence platforms. WDS wanted to understand the problems with the IBM platform as well as the current Stubhub offering. Their goal was to design an application for the analysts by understanding their pain points and expectations.
                        </p>
                    ...
                    <section className="flex-layout-section-full align-items-center">   
                        ...
                        <div className="content-block-65 margin-top-15">
                            <p className="content-text-18">
                                The discovery phase revealed that the analysts were not using the business intelligence platform for two reasons. The first was that the numbers were hidden in the chart displays (they needed to roll over data points to see the numbers). Most analysts need to compare numbers, which made the current platform unusable. The second issue was the 3 minute download time for each report. WDS discovered through  analysts' workflow that they would request data reports on an array of interests, such as venue analysis. Once the the report was prepared and ready to be consumed, the analysts would choose their report from a list and then the report would load the data visually in a chart. This process frustrated the analysts, and a 3 minute long download time was unacceptable. This was the largest issue and the reason that only 1 analyst was using the platform. </p>
                                
                                <p className="content-text-18">
                               WDS understood that if the team could not get the download time to under a minute, the project would be a failure. WDS explained to the team that no one will use it with a 3 minute download time. The engineers must solve the download time problem. The team accepted the challenge and completely refactored the backend to be fast, efficient and secure, reducing the download time from 3 minutes to under 30 seconds. </p>
                    ...
                    <div className="flex-layout-section-full margin-top-15">
                    ...
                    <div className="flex-items-align-top margin-top-25 content-block-65">
                        <ul className="dashed content-block-65 content-text-18">
                                ...
                                <li><a href="#solution6">Needed more users</a></li>
                                </ul> 
                    </div>
                    <div className="flex-layout-center-center content-block-65 flex-items-align-top margin-top-25">
                        <ul className="dashed content-block-65 content-text-18">
                            ...
                            <li><a href="#solution6">Only one user</a> </li> 
                            <li><a href="#solution1">No responsive design</a></li>
                            <li><a href="#solution4">Feature bloat</a></li>
                            <li><a href="#solution1">Report interface not customizable or fluid</a></li>
                ...
                <div className="hr-line-cs"></div>
                    ...
                    <section className="flex-layout-section-full align-items-center">  
                        <div className="header-title content-block-65">
                            Design Solutions
                        </div>
                        <div className="title content-block-65 margin-top-75">
                        ...
                        <div className="content-block-65 margin-top-15">
                            <p className="content-text-18">
                             In order to gain user traction, WDS needed to rethink data visualization design. Research showed  that almost all data visualization platforms were cold and sterile. The majority of designs were grey interfaces with crude user interactions. WDS decided to have a unique design, especially for data visualization. To their surprise the design was well received. WDS explained during the meeting that the design was a modern take on data visualization, the new UI was simple with  StubHub branding. The new design was inviting, bringing a sense of comfort to the user and most importantly the design incorporated larger numbers into the design.
                             </p>
            
                            <p className="content-text-18">
                                This design incorporated three elements: the user,  business and  current climate. The climate and the need to get user attention quickly led to a fully responsive design and branded with the StubHub colors. </p>  
                        </div>
                    </section>
                        ...
                        <section className="flex-layout-section-full align-items-center"> 
                            ...
                            <div className="content-block-65 margin-top-15">
                                <p className="content-text-18">
                                One of the major complaints about the the previous data tool was how the numbers in the charts were displayed. The numbers were not displayed until the analysts hovered over a data point on a chart. Most analysts were frustrated by this feature, because their workflow involved comparing numbers, which was currently impossible. The WDS solution to the problem was to design the interface so that the numbers were dominant and seamless in the design. The numbers were large and prominent allowing it to be the primary design factor. Understanding that analyst only scanned for highs and lows, those numbers were extracted from the chart and displayed in a 72 point bold font, allowing the primary reporting numbers to be clearly shown. </p>
                        ...
                        <div className="container-image-block flex-layout-center-center flex-layout-column margin-top-25">
                            ...
                            <div className="margin-top-15 caption width-70"><i>
                                The biggest feature request a simple, customizable data dashboard</i></div>
                        </div>
                        ...
                        <section className="flex-layout-section-full align-items-center">
                            ...
                            <div className="content-block-65 margin-top-15">
                                <p className="content-text-18">The KPI section is one of the most important features of any data visualization tools, providing key information for the decision makers. The design for this section needed to be clean and provide information that could be consumed at a glance. This section would stay open for hours. The issue with the current design was that it was unintelligible and unusable.</p>
                        ...
                        <section className="flex-layout-section-full align-items-center margin-top-15sm">
                            ...
                            <div className="content-block-65 margin-top-25">
                                <p className="content-text-18">
                                    <strong>The goal: Increase active users through marketing and communication strategies.</strong></p>
                                <p className="content-text-18">
