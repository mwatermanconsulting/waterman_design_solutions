            ...
            <div className="flex-layout-column"> 
                <div className="flex-layout-section-fixed yellow">
                    ...
                    <div className="flex-image-container flex-item-bottom flex-layout-center-center">
                        <h1 className="header-text-left title text-white">Our History</h1>
                        <img className="flex-image-container" src={history}  alt="Why WDS background" /> 
                     </div>
                    </div>
                </div>
                <div className="align-items-center border-bottom-5 callout-color-dark">
                   ...
                   <div className="grid-item2a">
                    <div className="subtitle">Surreal Beginnings </div>
                        <div className="content-block-why">
                            <p className="content-text-21 text-white"> WDS started in 1997 under its original name, Surreal Concepts by the husband and wife team, Terri and Michael Waterman. The mission was always to provide professional design services and marketing for a reasonable cost to small and mid-size companies. 
                            </p>
                        </div>
                    </div>
                ...
                <div className="content-block-cs">
                    ...
                    <div className="photo-content-color width-100 flex-layout-center-center image-background-border-tb margin-top-100" 
                          style={{minHeight: '275px'}}>
                            <p className="callout-text">Solving business communication issues<br/> solves design issues.</p>
                    </div>
                   ...
                   <div className="flex-layout-section-full  margin-top-100">
                    ...
                    `       <span className="mdl-typography--caption flex-layout-center border-bottom-1">Voice of the persona "Sally" speaking to the Motorola developers"
                            </span>
