            ...
            <section className="flex-layout-section-full align-items-center grey border-tb-5 margin-top-50 margin-top-50sm">
                ...
                <section className="float-left align-items-center flex-layout-column">
                    ...
                    <div className="content-block-65 content-text-18 margin-top-15">
                        ...
                        <br></br><div className="float-right">
                            <img className="width-250 padding-sm"  src={terri}  alt="Terri" /> <p className="width-250 caption">"Artists have always been leaders in society, helping others to achieve enlightened thinking and problem solving."</p>
                        </div>
