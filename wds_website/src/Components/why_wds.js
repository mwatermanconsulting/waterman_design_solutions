...
class why_wds extends Component {
    render () {
        return(
                    ...
                    <div className=" flex-layout-center-center padding-50">
                        <div className="content-header flex-layout-column">    
                            <div className="content-block width-75">
                                <div className=" text-white text-align-center">Your customer is the focus of the entire process.
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="flex-layout-section-full align-items-center" >
                <div className="content-header flex-layout-column">    
                        <p className="title padding-50 text-align-center">WDS builds emotionally rich, resonant digital solutions that enable users to fully realize technology’s complete potential, by simplifying everything your customers touch and feel.
                        </p>
                    </div>
            ...
            <div className="flex-layout-section-full align-items-center yellow-bg border-tb-5" >
                <div className="grid-2col-text-photo align-self-center width-100  margin-top-50 ">
                    <div className="2col-text grid-placeself-center width-70 margin-left-75">
                            <p className="content-header "> Design Solutions</p>
                            <p className="content-text-24 padding-10"> A methodology that reveals the truth</p>
                ...
                <div className="grid-2col-photo-text align-self-center width-100  margin-top-50 ">
                    ...
                    <div className="2col-text grid-placeself-center width-70 margin-left-75">
                            ...
                            <p className="content-text-24 padding-10"> Integrating design into your process</p>
                        ...
                        <div className="content-header flex-layout-column">    
                            <div className="content-block width-75">
                                <div className="text-align-center">
                                    <p className="subtitle text-align-center">From Surreal Beginnings…</p>
                                    <p className=" content-text-24">Since the beginning of the internet we have been building a culture of empathy, creativity, and inspiration.</p>
            ...
            <div className="flex-layout-section-full align-items-center">
                <div className="grid-2col-text width-70 margin-top-50 flex-section-align-center">
                        ...
                        <p className="subtitle">Experienced Teams</p>
                        <div className="content-block-75">
                            <p className="content-text-24">Our multi-disciplined teams teams work collaboratively to design software solutions based on user needs. Designers, strategists, marketers and program 
                            managers work together to achieve success. </p>
                            <p><a href="./core_offerings" target="_blank">Learn More...</a></p>
                        </div>
                    </div>
                    <div className="2col-text content-header flex-layout-column">
                        <p className="subtitle">Design Experience</p>
                            <div className="content-block-75">
                    ...
                    <div className="2col-text content-header flex-layout-column">
                        <p className="subtitle">Trend Setters</p>
                            <div className="content-block-75">
                                <p className="content-text-24 ">For the last 15 years WDS has been a leading trend setter for the industry. Our design solutions have been 
     ...
     <div className="flex-layout-section-full align-items-center yellow-bg border-tb-5 ">
            <div className="grid-4col-text padding-50" >
                <div>
                        <div className="content-header ">We'll get there as a team.</div>
            ...
            <div className="flex-layout-section-full align-items-center">
                ...
                <div className="2col-text grid-placeself-center width-70 margin-left-75">
                        ...
                        <div className="content-block">
                            <p className="content-header"> Curious to find out more? We’re more than happy to help! </p>
