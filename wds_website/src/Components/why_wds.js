...
import care from '../images/photo-why-wds-s2.png';
    ...
    render () {
        return(
                        ...
                        <div className="content-header flex-layout-column">
                            <h3 className="subtitle">Experience</h3>
                                <div className="content-block">
                                    ...
                                    All our <a href="./clients" target="_blank">clients</a> have full confidence that WDS can deliver the right results</p>
                                <p><a href="./core_offerings" target="_blank">Learn More...</a></p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="flex-layout-center padding-bottom-50 bottom-border">
                ...
                <div className="flex-layout-row flex-layout-center-center flex-layout-justified-sb yellow-bg"> 
                    ...
                    <div className="flex-layout-column">
                            <div className="container-image-block yellow-bg">
