...
import together from '../images/photo-why-wds-s2.png';
        ...
        return(
            <div className="flex-layout-column">
                    ...
                    <div className="item-a-nb content-header flex-layout-column">
                        <h3 className="subtitle text-white">Your Customer is the focus of the entire process</h3>
                            <div className="content-block-cs">
                                <p className="content-text-24">  The WDS Digital Marketing team researches, ideates, implements and optimizes sophisticated web marketing solutions tailored to the specific goals 
                ...
                <div className="flex-layout-section-full align-items-center red p" style={{minHeight:'400px'}}>
                    <div className="content-header flex-layout-column">    
                        <h3 className="title text-white padding-100 text-align-center">We have a unique, established methodology for understanding people in context. This drives everything we do. 
                        </h3>
                    </div>
               </div>
            ...
            <div className="container-grid-4col padding-100 yellow-bg">
