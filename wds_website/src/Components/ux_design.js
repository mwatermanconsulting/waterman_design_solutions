        ...
        return(
            ...
            <main>
                    <section className="flex-layout-section-full flex-layout-column flex-layout-center-center margin-top-100">
                        <div className="flex-layout-center-center content-block-60">
                            <div className="title">
                            ...
                            <div className="margin-top-15">
                                ...
                                <div className="callout-photo grid-placeself-center">
                    ...
                    <section className="content-header flex-layout-center-center flex-layout-column">
                        ...
                        <div className="flex-layout-center-center subtitle content-block-60 margin-top-15">
                        ...
                        <div className="content-block-60 margin-top-15">
                            ...
                            <p className="content-text-18">
                                ...
                                <div className="callout-photo grid-placeself-center">
                                    <img className="container-photo-callout" src={ux_s3}  alt="shaking hands" /> 
                                </div>
                ...
                >
                    ...
                    <div className="content-block-60 margin-top-15">
                        <p className="content-text-18">
                            Understanding people as they go about completing a task is essential to a positive user experience. Every action of that task is an experience with your product or service. The experience can be positive or negative depending how much of the user was taken into account when designing the product, system and user interface. User expectations have changed over the years. Simplicity is expected. Many changes have happened in the last decade with eetail.  Amazon simplified the shopping experience down to one click.  </p>
                        <p className="content-text-18">
                            ...
                            <div className="callout-photo grid-placeself-center">
                                    <img className="container-photo-callout" src={ux_s4}  alt="UX" /> 
                                </div>
                                <p className="caption">
                            Photo by Jude Beck on Unsplash</p>
                    </div>
                </section>
                ...
                <div className="flex-layout-section-full flex-layout-column flex-layout-center-center margin-top-100  grey border-top-5">
                    <div className="width-75 margin-top-50 align-center margin-bottom-50"> 
                       <a href="../communication_insights"> <img className="flex-image-container width-70 margin-bottom-50 " src={didyouknow}  alt="Ux" /> </a>
